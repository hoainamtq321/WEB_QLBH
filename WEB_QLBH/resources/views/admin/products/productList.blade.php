                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-button-action">
                        <a href="{{route('admin.products.edit',$product->product_id)}}" type="button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
                          <i class="fa fa-edit"></i>
                        </a>
                        <button type="button" data-id="{{$product->product_id}}" data-bs-toggle="tooltip" title="" class="btn btn-link btn-danger btn-delete" data-original-title="Remove">
...
<form  id="removeData" action="{{route('admin.products.destroy',"")}}" method="post">
  @method('DELETE')
  @csrf
</form>
@endsection